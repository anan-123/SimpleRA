...
bool syntacticParse()
{
    ...
    else if (possibleQueryType == "LOAD_MATRIX")
        return syntacticParseLOAD_MATRIX();
    else if (possibleQueryType == "EXPORT_MATRIX")
        return syntacticParseEXPORT_MATRIX();
    else if (possibleQueryType == "PRINT_MATRIX")
...
void ParsedQuery::clear()
{
    ...
    this->loadMatrixRelationName = "";

    this->printMatrixRelationName = "";
    this->exportMatrixRelationName = "";
    this->crossTransposeFirstMatrix = "";
    this->crossTransposeSecondMatrix = "";
...
bool isMatrixFileExists(string matrixName)
{
